(function($, global) {
	...
	var slotToAffix = {
		...
		'Mighty Belt'	: ['pri', 'vit', 'lps', 'arm', 'life', 'gen', 'lpfs'],
	...
	var slotToSec = {
		...
		'Boots'  		: ['gold', 'thorn', 'xp', 'glob', 'immo', 'dura', 'pick', 'lvlr'],
		'Bracers'		: ['rrdmg', 'rmdmg', 'gold', 'thorn', 'xp', 'pick', 'knock', 'dura', 'lvlr'],
		'Chest'  		: ['rrdmg', 'rmdmg', 'lpk', 'gold', 'thorn', 'xp', 'pick', 'dura', 'glob', 'lvlr'],
